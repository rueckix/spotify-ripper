...
***IMPORTANT*** Due to the playlist retrieval method of libspotify (pyspotify library) no longer functioning, a spotify web api account is now required for playlist ripping and emptying
